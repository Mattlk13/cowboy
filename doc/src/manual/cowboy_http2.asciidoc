...
Maximum number of header fields allowed per request field blocks.
This option is applied independently to header and trailer
field blocks.
...
* *2.17*: The `max_concurrent_streams` option now defaults to 100.
* *2.17*: The `max_authority_length` option was added.
* *2.16*: The `max_headers` option was added.
